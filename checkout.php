            ...
            <form action="" method="POST">
                ...
                <div class="flex">
                    <div class="box">
                        ...
                        <input type="email" name="email" require maxlength="50" placeholder="enter your email" class="input">

                        <p>your number <span>*</span></p>
                        <input type="number" name="number" require maxlength="10" min="0" max="9999999999" placeholder="enter your number" class="input">

                        <p>payment method <span>*</span></p>
                        <select name="method" class="input" require>
                        ...
                        <select name="address_type" class="input" require>
                    ...
                    <div class="box">
                        ...
                        <input type="text" name="flat" require maxlength="50" placeholder="e.g. flat no $ building no." class="input">
    
                        <p>adress line 02 <span>*</span></p>
                        <input type="text" name="street" require maxlength="50" placeholder="e.g. street name" class="input">

                        <p>city name <span>*</span></p>
                        <input type="text" name="city" require maxlength="50" placeholder="enter your city name" class="input">

                        <p>country name <span>*</span></p>
                        <input type="text" name="country" require maxlength="50" placeholder="enter your country name" class="input">

                        <p>pin code <span>*</span></p>
                        <input type="number" name="pin_code" require maxlength="6" min="0" max="999999" placeholder="enter your pin code" class="input">
            ...
            <div class="summary">
                ...
                <div class="flex">
                      ...
                      <div>
                        ...
                        <p class="price"><i class="fas fa-dollar-sign"></i> <?= $fetch_product['price']; ?> x 1</p>
                      </div>          
                </div>
                ...
                <p class="price"><i class="fas fa-dollar-sign"></i> <?= $f_product['price']; ?> x <?= $fetch_cart['qty']; ?></p>
                </div>          
                </div>
